            ...
            <Fade timeout={this.state.timeout} in={this.state.fadeIn}>
              <Card>
                <CardHeader>
                  ...
                  <div className="BeonshopCard-header-actions">
                    <Button color="link" className="BeonshopCard-header-action btn-setting"><i className="icon-settings"></i></Button>
                    <Button color="link" className="BeonshopCard-header-action btn-minimize" data-target="#collapseExample" onClick={this.toggle}><i className="icon-arrow-up"></i></Button>
                    <Button color="link" className="BeonshopCard-header-action btn-close" onClick={this.toggleFade}><i className="icon-close"></i></Button>
                  </div>
                </CardHeader>
