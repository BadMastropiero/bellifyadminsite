          ...
          <Col xl="6">
            <Card>
              <CardHeader>
                ...
                <div className="BeonshopCard-header-actions">
                  <a href="https://reactstrap.github.io/components/collapse/" rel="noreferrer noopener" target="_blank" className="BeonshopCard-header-action">
            ...
            <Card>
              <CardHeader>
                ...
                <div className="BeonshopCard-header-actions">
                  <a href="https://reactstrap.github.io/components/fade/" rel="noreferrer noopener" target="_blank" className="BeonshopCard-header-action">
                    <small className="text-muted">docs</small>
                  </a>
                </div>
              </CardHeader>
